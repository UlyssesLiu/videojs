...
var PlaylistMenuItem = function (_Component) {
  ...
  PlaylistMenuItem.prototype.createEl = function createEl() {
    ...
    var playingImgEl = document_1.createElement('div');

    playingImgEl.className = 'playing-img';

    titleContainerEl.appendChild(playingImgEl);
...
var PlayListPanel = function (_Component) {
  inherits(PlayListPanel, _Component);

  function PlayListPanel() {
    classCallCheck(this, PlayListPanel);
   ...
   */
  PlayListPanel.prototype.createEl = function createEl() {
...
var playlistUi = function playlistUi(options) {
  ...
  settings.el = elem;
  player.PlayListPanel = new PlayListPanel();
